...
class _DriverSignupScreenState extends State<DriverSignupScreen> {
  ...
  Future<void> _handleSignup() async {
    ...
    if (!FirebaseService.isInitialized) {
      setState(() {
        _localError = 'Firebase authentication is not available yet. Please complete Firebase setup before signing up.';
      });
      return;
    }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AuthTextField(
                      ...
                      label: 'Vehicle Info (e.g. Toyota Prius - ABC-123)',
                      icon: Icons.directions_car_outlined,
                      validator: (value) => value == null || value.isEmpty ? 'Please enter your vehicle info' : null,
                    ),
                    const SizedBox(height: AppConstants.spaceL),
                    AuthTextField(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: isLoading ? null : () => AppNavigator.toLogin(context),
